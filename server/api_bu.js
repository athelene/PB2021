...
app.get('/api/invitePlayer', function (req, res) {
  console.log('about to invite a player')
  var invitationPlayerEmail = req.query.invitationPlayerEmail;
  var userID = req.query.userID;
    authenticationOps.invitePlayer(invitationPlayerEmail, userID).then(result => {
